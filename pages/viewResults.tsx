                ...
                <section className="py-5 text-center container">
                  <div className="row py-lg-5">
                     <div className="col-lg-6 col-md-8 mx-auto">
                        <h1 className="fw-light">Blockchain-Based Voting System Real-Time Results</h1>
                     </div> 
                </div>
                </section>
                   ...
                   <div className="card shadow-sm">
                    ...
                    <div className="card-body">
                      ...
                      <div className="btn-group">
                        <button type="button" className="btn btn-sm btn-outline-danger">View</button>
                        <button type="button" className="btn btn-sm btn-outline-danger">Vote</button>
                    </div>
